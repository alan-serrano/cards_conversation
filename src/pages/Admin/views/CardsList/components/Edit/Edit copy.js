...
function Edit(props) {
    ...
    }, [card.question, card.topicId, card.difficulty, cardChanges.question, cardChanges.topicId, cardChanges.difficulty, selectedLanguage, card.language]);
    ...
    async function onRemove() {
        ...
        if(isEdit && (selectedLanguage === card.language)) {
            // Delete translation
